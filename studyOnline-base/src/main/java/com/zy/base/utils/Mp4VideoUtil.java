...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:\\developSoft\\ffmpeg\\ffmpeg-6.1.1-essentials_build\\bin\\ffmpeg.exe";//ffmpeg的安装位置
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ffmpeg_path = "D:\\developSoft\\ffmpeg\\ffmpeg-6.1.1-essentials_build\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\BaiduNetdiskDownload\\04354e9b7ff7cc153153336c748aab9d\\04354e9b7ff7cc153153336c748aab9d.mp4";
        //转换后mp4文件的名称
        String mp4_name = "test.gif";
        //转换后mp4文件的路径
        String mp4_path = "D:\\BaiduNetdiskDownload\\04354e9b7ff7cc153153336c748aab9d\\";
        //创建工具类对象
